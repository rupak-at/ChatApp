            ...
            <div className="grid gap-4">
              ...
              <div className="grid gap-2">
                <div className="grid grid-cols-1 items-center gap-1 w-fit">
                  <UpdateInfo />
                  <Button onClick={handleLogout} className={"bg-indigo-950 text-slate-100 outline-none  hover:text-slate-200 hover:bg-indigo-950"}>Logout</Button>
                </div>
              </div>
            </div>
          </PopoverContent>

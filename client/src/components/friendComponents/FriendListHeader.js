...
const FriendListHeader = ({ setSearchFriend, headerName }) => {
  return (
    // <div className="sticky top-0 z-10 flex flex-col gap-2 border-b border-gray-700 bg-gray-900 p-3 font-sans w-96 backdrop-blur-sm border-r">
  ...
  <div className="flex items-center justify-between">
    <p className="text-xl sm:text-2xl font-semibold text-gray-100">{headerName}</p>
  </div>
</div>
  );
};

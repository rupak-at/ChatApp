              ...
              <PopoverContent className="w-80 bg-zinc-700  border-zinc-900">
                <div className="grid gap-4">
                  <div className="space-y-2">
                    <Image src={selectGroup.groupIcon} height={50} width={50} alt="Profile_image" className="h-16 w-16 rounded-full border-gray-200"/>
                    <div className="w-full border"></div>
                    <h4 className="font-medium leading-none text-white ">{selectGroup.groupName}</h4>
                    <Button className="text-sm text-muted-foreground text-slate-200 bg-red-500 hover:bg-red-600 transition-all duration-300">
                      Leave
                    </Button>
                  </div>
                </div>
